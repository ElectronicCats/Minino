...
#define MBEDTLS_EXIT_FAILURE EXIT_FAILURE
    ...
    !defined(MBEDTLS_SSL_CLI_C) || !defined(MBEDTLS_NET_C) || !defined(MBEDTLS_RSA_C) || !defined(MBEDTLS_CERTS_C) || \
    !defined(MBEDTLS_PEM_PARSE_C) || !defined(MBEDTLS_CTR_DRBG_C) || !defined(MBEDTLS_X509_CRT_PARSE_C)
int main(void)
{
