                                   ...
                                   size_t               output_max_len)
{
    ...
    /* Check lHash */
    for (i = 0; i < hlen; i++) bad |= lhash[i] ^ *p++;
                                        ...
                                        size_t               output_max_len)
{
    ...
    ret = mbedtls_ct_rsaes_pkcs1_v15_unpadding(mode, buf, ilen, output, output_max_len, olen);
...
int mbedtls_rsa_rsassa_pss_sign_ext(mbedtls_rsa_context *ctx,
                                    ...
                                    unsigned char       *sig)
{
    return rsa_rsassa_pss_sign(ctx, f_rng, p_rng, MBEDTLS_RSA_PRIVATE, md_alg, hashlen, hash, saltlen, sig);
}
...
int mbedtls_rsa_rsassa_pss_sign(mbedtls_rsa_context *ctx,
                                ...
                                unsigned char       *sig)
{
    return rsa_rsassa_pss_sign(ctx, f_rng, p_rng, mode, md_alg, hashlen, hash, MBEDTLS_RSA_SALT_LEN_ANY, sig);
}
#endif /* MBEDTLS_PKCS1_V21 */
