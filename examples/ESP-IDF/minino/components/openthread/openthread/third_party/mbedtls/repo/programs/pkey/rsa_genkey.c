...
#if defined(MBEDTLS_BIGNUM_C) && defined(MBEDTLS_ENTROPY_C) && defined(MBEDTLS_RSA_C) && defined(MBEDTLS_GENPRIME) && \
...
#if !defined(MBEDTLS_BIGNUM_C) || !defined(MBEDTLS_ENTROPY_C) || !defined(MBEDTLS_RSA_C) || \
    !defined(MBEDTLS_GENPRIME) || !defined(MBEDTLS_FS_IO) || !defined(MBEDTLS_CTR_DRBG_C)
int main(void)
{
