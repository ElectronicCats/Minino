...
#if !defined(MBEDTLS_MD_C) || !defined(MBEDTLS_ENTROPY_C) || !defined(MBEDTLS_RSA_C) || !defined(MBEDTLS_SHA256_C) || \
    !defined(MBEDTLS_PK_PARSE_C) || !defined(MBEDTLS_FS_IO) || !defined(MBEDTLS_CTR_DRBG_C)
int main(void)
{
