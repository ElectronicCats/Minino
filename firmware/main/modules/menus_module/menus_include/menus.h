...
typedef enum {
  ...
  MENU_GPIO_APPS,
  MENU_SURVEILLANCE,
  MENU_SURVEILLANCE_ALL,
  MENU_SURVEILLANCE_FLOCK,
  MENU_SURVEILLANCE_TRACKERS,
  MENU_SURVEILLANCE_SIM,
  MENU_SURVEILLANCE_SIM_ALL,
  MENU_SURVEILLANCE_SIM_FLOCK,
  MENU_SURVEILLANCE_SIM_AIRTAG,
  MENU_SURVEILLANCE_SIM_AXON,
  MENU_SURVEILLANCE_SIM_SKIMMER,
  MENU_SURVEILLANCE_HELP,
  ...
  MENU_BLUETOOTH_SPAM,
  MENU_BLUETOOTH_SPAM_APPLE,
  MENU_BLUETOOTH_SPAM_ANDROID,
  MENU_BLUETOOTH_SPAM_WINDOWS,
  MENU_BLUETOOTH_SPAM_SAMSUNG,
  MENU_BLUETOOTH_SPAM_ALL,
  MENU_BLUETOOTH_HID,
  MENU_BLUETOOTH_ADV,
  /* Zigbee applications */
...
//  .is_visible            = true},
    {.display_name = "Surveillance",
     ...
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Scan All",
     .menu_idx = MENU_SURVEILLANCE_ALL,
     .parent_idx = MENU_SURVEILLANCE,
     .entry_cmd = "surv_all",
     .last_selected_submenu = 0,
     .on_enter_cb = surveillance_module_begin_all,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Flock / ALPR",
     .menu_idx = MENU_SURVEILLANCE_FLOCK,
     .parent_idx = MENU_SURVEILLANCE,
     .entry_cmd = "surv_flock",
     .last_selected_submenu = 0,
     .on_enter_cb = surveillance_module_begin_flock,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Trackers (BLE)",
     .menu_idx = MENU_SURVEILLANCE_TRACKERS,
     .parent_idx = MENU_SURVEILLANCE,
     .entry_cmd = "surv_ble",
     .last_selected_submenu = 0,
     .on_enter_cb = surveillance_module_begin_trackers,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Simulator (Tx)",
     .menu_idx = MENU_SURVEILLANCE_SIM,
     .parent_idx = MENU_SURVEILLANCE,
     .last_selected_submenu = 0,
     .on_enter_cb = NULL,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Tx: All (Loop)",
     .menu_idx = MENU_SURVEILLANCE_SIM_ALL,
     .parent_idx = MENU_SURVEILLANCE_SIM,
     .entry_cmd = "sim_all",
     .last_selected_submenu = 0,
     .on_enter_cb = surv_sim_begin_all,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Tx: Flock T4 (WiFi)",
     .menu_idx = MENU_SURVEILLANCE_SIM_FLOCK,
     .parent_idx = MENU_SURVEILLANCE_SIM,
     .entry_cmd = "sim_flock",
     .last_selected_submenu = 0,
     .on_enter_cb = surv_sim_begin_flock,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Tx: AirTag (BLE)",
     .menu_idx = MENU_SURVEILLANCE_SIM_AIRTAG,
     .parent_idx = MENU_SURVEILLANCE_SIM,
     .entry_cmd = "sim_airtag",
     .last_selected_submenu = 0,
     .on_enter_cb = surv_sim_begin_airtag,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Tx: Axon Cam (BLE)",
     .menu_idx = MENU_SURVEILLANCE_SIM_AXON,
     .parent_idx = MENU_SURVEILLANCE_SIM,
     .entry_cmd = "sim_axon",
     .last_selected_submenu = 0,
     .on_enter_cb = surv_sim_begin_axon,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Tx: Skimmer (BLE)",
     .menu_idx = MENU_SURVEILLANCE_SIM_SKIMMER,
     .parent_idx = MENU_SURVEILLANCE_SIM,
     .entry_cmd = "sim_skimmer",
     .last_selected_submenu = 0,
     .on_enter_cb = surv_sim_begin_skimmer,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Help & Info",
     .menu_idx = MENU_SURVEILLANCE_HELP,
     .parent_idx = MENU_SURVEILLANCE,
     .entry_cmd = "surv_help",
     .last_selected_submenu = 0,
     .on_enter_cb = surveillance_module_show_help,
     .on_exit_cb = NULL,
     .is_visible = true},
    ...
    {.display_name = "Spam",
     ...
     .is_visible = true},
    {.display_name = "Apple",
     .menu_idx = MENU_BLUETOOTH_SPAM_APPLE,
     .parent_idx = MENU_BLUETOOTH_SPAM,
     .entry_cmd = "spam_apple",
     .last_selected_submenu = 0,
     .on_enter_cb = ble_spam_apple_begin,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Android",
     .menu_idx = MENU_BLUETOOTH_SPAM_ANDROID,
     .parent_idx = MENU_BLUETOOTH_SPAM,
     .entry_cmd = "spam_android",
     .last_selected_submenu = 0,
     .on_enter_cb = ble_spam_android_begin,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Windows",
     .menu_idx = MENU_BLUETOOTH_SPAM_WINDOWS,
     .parent_idx = MENU_BLUETOOTH_SPAM,
     .entry_cmd = "spam_windows",
     .last_selected_submenu = 0,
     .on_enter_cb = ble_spam_windows_begin,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Samsung",
     .menu_idx = MENU_BLUETOOTH_SPAM_SAMSUNG,
     .parent_idx = MENU_BLUETOOTH_SPAM,
     .entry_cmd = "spam_samsung",
     .last_selected_submenu = 0,
     .on_enter_cb = ble_spam_samsung_begin,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "All",
     .menu_idx = MENU_BLUETOOTH_SPAM_ALL,
     .parent_idx = MENU_BLUETOOTH_SPAM,
     .entry_cmd = "spam_all",
     .last_selected_submenu = 0,
     .on_enter_cb = ble_spam_all_begin,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "HID",
