...
// #endif
    ...
    {.display_name = "UART Bridge",
     ...
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Start Bridge",
     .menu_idx = MENU_GPIO_UART_BRIDGE_START,
     .parent_idx = MENU_GPIO_UART_BRIDGE,
     .entry_cmd = NULL,
     .last_selected_submenu = 0,
     .on_enter_cb = NULL,
     .on_exit_cb = NULL,
    ...
    {.display_name = "Baudrate",
     .menu_idx = MENU_GPIO_UART_BRIDGE_BAUDRATE,
     .parent_idx = MENU_GPIO_UART_BRIDGE,
     .entry_cmd = NULL,
     .last_selected_submenu = 0,
     .on_enter_cb = NULL,
    ...
    {.display_name = "Data Bits",
     .menu_idx = MENU_GPIO_UART_BRIDGE_DATA_BITS,
     .parent_idx = MENU_GPIO_UART_BRIDGE,
     .entry_cmd = NULL,
     .last_selected_submenu = 0,
     .on_enter_cb = NULL,
     ...
     .is_visible = true},
    {.display_name = "Parity",
     .menu_idx = MENU_GPIO_UART_BRIDGE_PARITY,
     .parent_idx = MENU_GPIO_UART_BRIDGE,
     .entry_cmd = NULL,
     .last_selected_submenu = 0,
     .on_enter_cb = NULL,
    ...
    {.display_name = "Stop Bits",
     .menu_idx = MENU_GPIO_UART_BRIDGE_STOP_BITS,
     .parent_idx = MENU_GPIO_UART_BRIDGE,
     .entry_cmd = NULL,
     .last_selected_submenu = 0,
     .on_enter_cb = NULL,
