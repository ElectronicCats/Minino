...
#if !defined(MBEDTLS_X509_CSR_WRITE_C) || !defined(MBEDTLS_FS_IO) || !defined(MBEDTLS_PK_PARSE_C) || \
    !defined(MBEDTLS_SHA256_C) || !defined(MBEDTLS_ENTROPY_C) || !defined(MBEDTLS_CTR_DRBG_C) ||     \
