...
/* This macro determines whether CBC is supported. */
    ...
    (defined(MBEDTLS_AES_C) || defined(MBEDTLS_CAMELLIA_C) || defined(MBEDTLS_ARIA_C) || defined(MBEDTLS_DES_C))
 ...
 */
static inline psa_key_id_t mbedtls_ssl_get_opaque_psk(const mbedtls_ssl_context *ssl)
{
