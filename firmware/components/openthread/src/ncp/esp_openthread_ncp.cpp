...
otError NcpBase::VendorCommandHandler(uint8_t aHeader, unsigned int aCommand) {
  ...
  otPlatLog(OT_LOG_LEVEL_WARN, OT_LOG_REGION_NCP,
            "VendorCommandHandler Not Implemented");
...
void NcpBase::VendorHandleFrameRemovedFromNcpBuffer(
  ...
  switch (aPropKey) {
    ...
    case SPINEL_PROP_VENDOR_ESP_SET_PENDINGMODE: {
      ...
      esp_ieee802154_set_pending_mode(
          static_cast<esp_ieee802154_pending_mode_t>(pending_mode));
      break;
    }
