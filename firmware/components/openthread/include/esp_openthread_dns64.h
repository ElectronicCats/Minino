...
extern "C" {
#endif
// The network data change callback sets the dns server address of index 0,
// while the CLI sets the dns server address of index 1.
 ...
 *
 */
int esp_openthread_getaddrinfo_dns64(const char* nodename,
                                     const char* servname,
