...
inline static void Hacl_Bignum_Fmul_fmul(uint64_t *output, uint64_t *input, uint64_t *input2)
{
    ...
    KRML_CHECK_SIZE(sizeof(FStar_UInt128_uint128), (uint32_t)5U);
    {
        ...
        {
            uint32_t _i;
            for (_i = 0U; _i < (uint32_t)5U; ++_i) t[_i] = FStar_UInt128_uint64_to_uint128((uint64_t)0U);
        }
        {
...
static void Hacl_Bignum_Fsquare_fsquare_times_(uint64_t *input, FStar_UInt128_uint128 *tmp, uint32_t count1)
{
    ...
    for (i = (uint32_t)1U; i < count1; i = i + (uint32_t)1U) Hacl_Bignum_Fsquare_fsquare_(tmp, input);
}
...
inline static void Hacl_Bignum_fscalar(uint64_t *output, uint64_t *b, uint64_t s)
{
    KRML_CHECK_SIZE(sizeof(FStar_UInt128_uint128), (uint32_t)5U);
    {
        ...
        {
            uint32_t _i;
            for (_i = 0U; _i < (uint32_t)5U; ++_i) tmp[_i] = FStar_UInt128_uint64_to_uint128((uint64_t)0U);
        }
        {
            FStar_UInt128_uint128 b4;
            FStar_UInt128_uint128 b0;
...
inline static void Hacl_Bignum_fmul(uint64_t *output, uint64_t *a, uint64_t *b) { Hacl_Bignum_Fmul_fmul(output, a, b); }

inline static void Hacl_Bignum_crecip(uint64_t *output, uint64_t *input) { Hacl_Bignum_Crecip_crecip(output, input); }
