...
void mbedtls_md4_init(mbedtls_md4_context *ctx) { memset(ctx, 0, sizeof(mbedtls_md4_context)); }
...
void mbedtls_md4_clone(mbedtls_md4_context *dst, const mbedtls_md4_context *src) { *dst = *src; }
...
void mbedtls_md4_starts(mbedtls_md4_context *ctx) { mbedtls_md4_starts_ret(ctx); }
#endif
...
#if !defined(MBEDTLS_DEPRECATED_REMOVED)
void mbedtls_md4_finish(mbedtls_md4_context *ctx, unsigned char output[16]) { mbedtls_md4_finish_ret(ctx, output); }
#endif
