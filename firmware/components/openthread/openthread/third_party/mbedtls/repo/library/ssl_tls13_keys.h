...
#define MBEDTLS_SSL_TLS1_3_LABEL(name, string) const unsigned char name[sizeof(string) - 1];
...
#define MBEDTLS_SSL_TLS1_3_LBL_WITH_LEN(LABEL) mbedtls_ssl_tls1_3_labels.LABEL, sizeof(mbedtls_ssl_tls1_3_labels.LABEL)

#define MBEDTLS_SSL_TLS1_3_KEY_SCHEDULE_MAX_LABEL_LEN sizeof(union mbedtls_ssl_tls1_3_labels_union)
