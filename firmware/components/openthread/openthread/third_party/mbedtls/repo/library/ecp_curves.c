...
static int ecp_mod_p521(mbedtls_mpi *N)
{
    ...
    for (i = P521_WIDTH; i < N->n; i++) N->p[i] = 0;
...
static int ecp_mod_p255(mbedtls_mpi *N)
{
    ...
    for (i = P255_WIDTH; i < N->n; i++) N->p[i] = 0;
...
static int ecp_mod_p448(mbedtls_mpi *N)
{
    ...
    /* N = A0 */
    for (i = P448_WIDTH; i < N->n; i++) N->p[i] = 0;
    ...
    for (i = P224_WIDTH_MAX; i < M.n; ++i) Mp[i] = 0;
