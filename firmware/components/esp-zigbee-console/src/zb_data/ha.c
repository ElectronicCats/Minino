...
/* The table contains the information of HA standard device supported by
 * esp-zigbee-sdk.
 *
 * Note: The entries in the table MUST be arranged in ascending order of device
 * type ID.
 */
static const esp_zcl_ha_device_t s_ha_device_table[] = {
    HA_DEVICE_ENTRY(on_off_switch, ESP_ZB_HA_ON_OFF_SWITCH_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORT(level_control_switch,
                              ESP_ZB_HA_LEVEL_CONTROL_SWITCH_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORT(on_off_output, ESP_ZB_HA_ON_OFF_OUTPUT_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORT(level_controllable_output,
                              ESP_ZB_HA_LEVEL_CONTROLLABLE_OUTPUT_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORT(scene_selector,
                              ESP_ZB_HA_SCENE_SELECTOR_DEVICE_ID),
    HA_DEVICE_ENTRY(configuration_tool, ESP_ZB_HA_CONFIGURATION_TOOL_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORT(remote_control,
                              ESP_ZB_HA_REMOTE_CONTROL_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORT(combined_interface,
                              ESP_ZB_HA_COMBINED_INTERFACE_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORT(range_extender,
    ...
    HA_DEVICE_ENTRY(door_lock_controller,
                    ESP_ZB_HA_DOOR_LOCK_CONTROLLER_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORT(simple_sensor, ESP_ZB_HA_SIMPLE_SENSOR_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORT(consumption_awareness,
                              ESP_ZB_HA_CONSUMPTION_AWARENESS_DEVICE_ID),
    ...
    HA_DEVICE_ENTRY_UNSUPPORT(meter_interface,
                              ESP_ZB_HA_METER_INTERFACE_DEVICE_ID),
    HA_DEVICE_ENTRY(on_off_light, ESP_ZB_HA_ON_OFF_LIGHT_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORT(dimmable_light,
                              ESP_ZB_HA_DIMMABLE_LIGHT_DEVICE_ID),
    HA_DEVICE_ENTRY(color_dimmable_light,
                    ESP_ZB_HA_COLOR_DIMMABLE_LIGHT_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORT(dimmable_switch,
                              ESP_ZB_HA_DIMMER_SWITCH_DEVICE_ID),
    HA_DEVICE_ENTRY(color_dimmable_switch,
                    ESP_ZB_HA_COLOR_DIMMER_SWITCH_DEVICE_ID),
    ...
    HA_DEVICE_ENTRY(window_covering_controller,
                    ESP_ZB_HA_WINDOW_COVERING_CONTROLLER_DEVICE_ID),
    HA_DEVICE_ENTRY_UNSUPPORT(heating_cooling_unit,
                              ESP_ZB_HA_HEATING_COOLING_UNIT_DEVICE_ID),
    ...
    HA_DEVICE_ENTRY_UNSUPPORT(ias_control_indicating,
                              ESP_ZB_HA_IAS_CONTROL_INDICATING_EQUIPMENT_ID),
    HA_DEVICE_ENTRY_UNSUPPORT(ias_ancillary_control,
