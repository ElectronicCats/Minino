...
void cli_output_array(const char* arr_name,
                      void* array,
                      size_t arr_cnt,
                      size_t element_size,
                      cli_output_element_func_t write_element,
                      void* user_ctx) {
...
static int write_u8(const uint8_t* pval,
                    char* buf,
                    size_t buf_size,
                    const char* format) {
...
static int write_u16(const uint16_t* pval,
                     char* buf,
                     size_t buf_size,
                     const char* format) {
  return snprintf(buf, buf_size, format, *pval);
...
void cli_output_array_u8(const char* arr_name,
                         uint8_t* array,
                         size_t arr_cnt,
                         const char* format) {
  cli_output_array(arr_name, array, arr_cnt, sizeof(*array),
                   (cli_output_element_func_t) &write_u8, (void*) format);
}

void cli_output_array_u16(const char* arr_name,
                          uint16_t* array,
                          size_t arr_cnt,
                          const char* format) {
  cli_output_array(arr_name, array, arr_cnt, sizeof(*array),
                   (cli_output_element_func_t) &write_u16, (void*) format);
}
...
void cli_output_table_header(uint8_t column_num,
