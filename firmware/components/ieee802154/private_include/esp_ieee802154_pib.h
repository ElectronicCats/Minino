...
typedef struct {
  ...
  bool enhance_ack_tx; /*!< A flag indicates enh-ack timing mode is enabled or
                          not */
...
/**
 * @brief  Get the state of PIB, if is pending, the PIB should be updated to
 * hardware.
 *
 * @return
 ...
 *
 * @param[in]  enable  True for enabling the auto-ack transmission mode,
 * otherwise false.
 *
 */
 ...
 *
 * @param[in]  enable  True for enabling the auto-ack receiving mode, otherwise
 * false.
 *
 */
 ...
 *
 * @param[in]  enable  True for enabling the enh-ack timing mode, otherwise
 * false.
 *
 */
 ...
 *
 * @param[in]  enable  True for configuring the device coordinator, otherwise
 * false.
 *
 */
...
/**
 * @brief  Configure the radio mode when the radio is going to enter idle to the
 * PIB.
 *
 * @param[in]  enable  True for continuing to receive when the radio is going to
 * enter ilde, otherwise false.
 *
 */
 ...
 *
 * @return
 *        - True for continuing to receive when the radio is going to enter
 * ilde, otherwise false.
 *
 */
