...
esp_err_t esp_ieee802154_set_short_address(uint16_t short_address) {
  ieee802154_ll_set_multipan_short_addr(ESP_IEEE802154_MULTIPAN_0,
                                        short_address);
  return ESP_OK;
}
...
esp_err_t esp_ieee802154_clear_pending_addr(const uint8_t* addr,
                                            bool is_short) {
...
__attribute__((weak)) void sniffer_esp_ieee802154_receive_done(
    uint8_t* data,
    esp_ieee802154_frame_info_t* frame_info) {}
...
__attribute__((weak)) void esp_ieee802154_transmit_done(
    const uint8_t* frame,
    const uint8_t* ack,
